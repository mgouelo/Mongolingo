...
export const questions = [
  ...
  },
  {
    ...
    explication: "L'opérateur $exists permet de trouver les documents où un champ spécifique est présent, peu importe sa valeur. C'est très utile en NoSQL."
  },
  {
    id: 15,
    niveau: "moyen",
  ...
  },
  {
    id: 22,
    niveau: "difficile",
    question: "Récupérer tous les emprunts en y associant les détails complets du livre emprunté (Jointure NoSQL).",
  ...
  },
  {
    ...
    explication: "Dans MongoDB, il n'y a pas de mot-clé 'HAVING' comme en SQL. On utilise simplement une étape $match APRES une étape $group pour filtrer sur les résultats agrégés."
  },
  {
    id: 29,
    niveau: "difficile",
  ...
  },
  {
    id: 30,
    niveau: "difficile",
    question: "Récupérer les emprunts avec les détails complets du livre ET de l'abonné associé (Double jointure).",
